package com.sanalstil.pEJB.pDatabase.pOracle.pIddaa.pBetList.pTennis;
...
public class cTennis  extends cBaseDBPackage 
{
	public cTennis(cOracleDB _OrcaleDb)
	{
		super(_OrcaleDb);
		LoadSubPackage();
	}
	...
	public cDataJsonResult GetMatchProgram()
	{
        ...
        try {
        	...
        	cStartup.ServerLogger.FileInfo("Called cTennis->GetMatchProgram()");
        	
        	__Connection = OrcaleDB.DataSource.getConnection();
           	__PrepareCall = __Connection.prepareCall("begin EBAHIS.EMI_P_IDDAA_BETLIST_v2.getcTennis(?); end;");
			...
			cStartup.ServerLogger.FileInfo("Called cTennis->GetMatchProgram() -> SUCCESS");
		}
		catch (SQLException _Ex) 
		{
        	cStartup.ServerLogger.ConsolError("Error..! -> com.sanalstil.pEJB.pDatabase.pOracle.pIddaa.pBetList.pTennis.cTennis.GetMatchProgram()");
        	cStartup.ServerLogger.FileError("Error..! -> com.sanalstil.pEJB.pDatabase.pOracle.pIddaa.pBetList.pTennis.cTennis.GetMatchProgram()", _Ex);
		}
		finally
		{
